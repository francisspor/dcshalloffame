      ...
      <header className="bg-green-700 text-white shadow-lg">
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-between">
            <div>
              <Link href="/staff-hall-of-fame" className="text-green-200 hover:text-white transition-colors">
                ← Back to Staff Hall of Fame
              </Link>
            </div>
          </div>
            ...
            {member.imageUrl && (
              <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center">
                <img
                  src={member.imageUrl}
                  alt={member.name}
                  className="w-40 h-40 object-cover rounded-full border-4 border-green-300 shadow-md mb-2"
                  loading="lazy"
                />
              </div>
            )}
