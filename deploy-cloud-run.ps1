...
gcloud run deploy $ServiceName `
  ...
  --cpu 1 `
  --max-instances 10 `
  --set-env-vars ASPNETCORE_ENVIRONMENT=Production, AllowedOrigins__0=https://dcshalloffame.vercel.app, AllowedOrigins__1=http://localhost:3000, AllowedOrigins__2=https://localhost:3000, JwtSettings__SecretKey=9Hh4FWYkHkaOk1Qf5doAFqABPQ7AoLOgrYSwqg4+Rr0=
